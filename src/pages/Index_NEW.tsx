...
const API_BASE_URL = "https://hackaton-mintic.duckdns.org/api2";
...
const Index = () => {
  ...
  useEffect(() => {
    checkServerStatus().then(isActive => {
      if (!isActive) {
        setError("El servidor backend no está disponible. Por favor, verifica que esté ejecutándose en https://hackaton-mintic.duckdns.org/api2");
