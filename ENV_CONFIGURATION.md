...
- **`VITE_API_BASE_URL`**: URL del servidor backend
  - Valor por defecto: `https://hackaton-mintic.duckdns.org/api2`
  - Ejemplo: `VITE_API_BASE_URL=https://hackaton-mintic.duckdns.org/api2`
...
```typescript
export const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || "https://hackaton-mintic.duckdns.org/api2";
